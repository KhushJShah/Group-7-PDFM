...
# Filter data1 to select rows where state is CA, NV, or AZ
data1_filtered = data1[data1['state'].isin(['CA', 'NV', 'AZ'])]
...
merged_data_unemployment_r9 = pd.merge(data1_filtered, data2, on='zipcode', how='inner')

#%%
# Displaying the final merged dataset

print(merged_data_unemployment_r9.head())

# %%
# Save the DataFrame to the specified path
file_path = r"C:/Users/nupur\computer/Desktop/Group-7-PDFM/Project/data/merged_data_unemployment_r9.csv"
merged_data_unemployment_r9.to_csv(file_path, index=False)
